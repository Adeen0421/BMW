...
const mseries=()=>{
   ...
   const mcardata=[
        ...
        {id:3 ,name:'BMW M4 CS',price:'PKR 34,447,200',description:'0 to 100 km/h in 3.4 seconds',image:'/bmw-m4cs.jpg'},
        {id:4 ,name:'BMW M5',price:'PKR 34,169,400',description:'0 to 100km/h in 3.5 seconds',image:'/bmw-m5.webp'},
    {id:4 ,name:'BMW M5 CS',price:'PKR 40,003,200',description:'0 to 100km/h in 3 seconds',image:'/bmw-mcs.jpg'},
    ...
    <div>
     <div className='mcars'>
       ...
       <Image width={"0"} height={"0"} src={cars.image} alt={cars.name}/>
       <h3>{cars.name}</h3>
